...
import com.example.baoxiaojianapp.baoxiaojianapp.Utils.CameraOrientationDetector;
import com.example.baoxiaojianapp.baoxiaojianapp.Utils.ScreenSizeUtil;
...
public class CameraSurfaceView extends SurfaceView implements SurfaceHolder.Callback, Camera.AutoFocusCallback {
    ...
    public void surfaceCreated(SurfaceHolder holder) {
        if (mCamera == null) {
            try {
                ...
                ToastUtils.showShort("摄像头异常，请检查摄像头权限是否应许");
                return;
            }
            try {
    ...
    private void setCameraParams(int width, int height) {
        ...
        mCamera.setErrorCallback(new Camera.ErrorCallback() {
            ...
            public void onError(int error, Camera camera) {
                ...
                ToastUtils.showShort(error_str);
                Log.i(TAG, error_str);
            }
        });
    ...
    public boolean openCamera(int camera_id) {
        ...
        try {
            ...
            e.printStackTrace();
            ToastUtils.showShort("请先开启摄像头权限");
