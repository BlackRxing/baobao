...
//    private final int GREEN_RADIUS = 20;//变绿半径
    ...
    //最后的半径
    private final int MINCirCle=20;
...
//            }
    ...
    private void showAnimView() {
        ...
        if (lineAnimator == null) {
            lineAnimator = ValueAnimator.ofInt(0, 20);//动画帧速度
            ...
            lineAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                ...
                public void onAnimationUpdate(ValueAnimator animation) {
                    int animationValue = (Integer) animation
                            .getAnimatedValue();
                    if(lastValue!=animationValue&&radius>=mScreenWidth*0.05){
