...
//        File file = new File(dir, hashKeyForDisk(UUID.randomUUID()+"") + ".jpg");
        File file = new File(PathUtils.getFilePath(MyApplication.getContext(),"appraisal"), System.currentTimeMillis() + ".jpg");
        try {
            if (!file.exists())
                file.createNewFile();
        } catch (IOException e) {
